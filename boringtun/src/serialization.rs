pub(crate) struct PrivateKeyBytes(pub [u8; 32]);

impl std::str::FromStr for PrivateKeyBytes {
    type Err = &'static str;
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(PrivateKeyBytes(internal))
    }
}

pub(crate) struct PublicKeyBytes(pub [u8; 65]);
